...
local Library do 
    ...
    do 
        ...
        Library.Window = function(self, Data)
            ...
            local IsMobileMode = IsMobile or (Data and (Data.Mode == "mobile" or Data.mode == "mobile"))
            local Adaptive = IsMobileMode and {
                MainFrameSize = UDim2New(0.96, 0, 0.94, 0),
                MainFramePosition = UDim2New(0.5, 0, 0.54, 0),
                LeftTabsSize = UDim2New(0, 112, 1, 0),
                TabSize = UDim2New(0, 112, 0, 46),
                TabIconSize = UDim2New(0, 20, 0, 20),
                TabIconPosition = UDim2New(0, 12, 0.5, 0),
                TabTextPosition = UDim2New(0, 38, 0.5, 0),
                TabTextSize = 13,
                ContentPadding = UDimNew(0, 8),
                ToggleButtonPosition = UDim2New(0.9, -8, 0.92, -8),
                ToggleButtonSize = UDim2New(0, 58, 0, 58)
            } or {
                MainFrameSize = UDim2New(0, 677, 0, 644),
                MainFramePosition = UDim2New(0.5, 0, 0.5, 0),
                LeftTabsSize = UDim2New(0, 225, 1, 0),
                TabSize = UDim2New(0, 200, 0, 40),
                TabIconSize = UDim2New(0, 18, 0, 18),
                TabIconPosition = UDim2New(0, 16, 0.5, 0),
                TabTextPosition = UDim2New(0, 45, 0.5, 0),
                TabTextSize = 14,
                ContentPadding = UDimNew(0, 10),
                ToggleButtonPosition = UDim2New(0.95, -8, 0.9, -8),
                ToggleButtonSize = UDim2New(0, 58, 0, 58)
            }
            ...
            local Items = { } do
                Items["MainFrame"] = Instances:Create("Frame", {
                    ...
                    Position = Adaptive.MainFramePosition,
                    Size = Adaptive.MainFrameSize,
                    ZIndex = 2,
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(27, 25, 29)
                ...
                Items["ToggleButton"] = Instances:Create("TextButton", {
                    ...
                    Position = Adaptive.ToggleButtonPosition,
                    Size = Adaptive.ToggleButtonSize,
                    ZIndex = 10,
                    TextSize = 24,
                    BackgroundColor3 = FromRGB(0, 116, 224)
                })
                ...
                Items["ToggleButton"].Instance.Visible = false
            ...
            function Window:SetCenter()
                ...
                Items["MainFrame"].Instance.Position = Adaptive.MainFramePosition
            end
            ...
            function Window:SetOpen(Bool)
                ...
                if Window.IsOpen then 
                    ...
                    if Items["ToggleButton"] then
                        Items["ToggleButton"].Instance.Visible = Window.IsMinimized
                    end
                end
                ...
                NewTween.Tween.Completed:Connect(function()
                    ...
                    if not Window.IsOpen and Items["ToggleButton"] then
                        Items["ToggleButton"].Instance.Visible = Window.IsMinimized
                    end
                end)
            end
        ...
        Library.Page = function(self, Data)
            ...
            local Items = { } do
                Items["Inactive"] = Instances:Create("TextButton", {
                    ...
                    BackgroundTransparency = 1,
                    BorderSizePixel = 0,
                    Size = IsMobileMode and UDim2New(0, 112, 0, 46) or UDim2New(0, 200, 0, 40),
                    ZIndex = 2,
                    TextSize = 14,
                    BackgroundColor3 = FromRGB(124, 163, 255)
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    ImageColor3 = FromRGB(255, 255, 255),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = IsMobileMode and UDim2New(0, 20, 0, 20) or UDim2New(0, 18, 0, 18),
                    AnchorPoint = Vector2New(0, 0.5),
                    Image = "rbxassetid://"..Page.Icon,
                    BackgroundTransparency = 1,
                    Position = IsMobileMode and UDim2New(0, 12, 0.5, 0) or UDim2New(0, 16, 0.5, 0),
                    ZIndex = 2,
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                ...
                Items["Text"] = Instances:Create("TextLabel", {
                    ...
                    Size = UDim2New(0, 0, 0, 15),
                    BackgroundTransparency = 1,
                    Position = IsMobileMode and UDim2New(0, 38, 0.5, 0) or UDim2New(0, 45, 0.5, 0),
                    BorderSizePixel = 0,
                    ZIndex = 2,
                    TextSize = IsMobileMode and 13 or 14,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })  Items["Text"]:AddToTheme({TextColor3 = "Text"})      
